        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden py-8 px-4 sm:px-8 space-y-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300">
              Use your college credentials to access the election portal
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <article>
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center mt-8 py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-700 dark:hover:bg-blue-800 ${
          ...
          <article className="text-center text-sm text-gray-500 dark:text-gray-400">
            <p>
              By signing in, you agree to our election policies and code of
              conduct.
            </p>
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="flex items-center text-sm my-2 font-medium text-gray-700 dark:text-gray-200 hover:text-gray-500 focus:outline-none  dark:hover:text-gray-400"
