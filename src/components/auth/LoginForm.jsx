          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <article>
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex justify-center mt-8 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-700 dark:hover:bg-blue-800 ${
